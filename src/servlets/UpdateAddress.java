...
public class UpdateAddress extends HttpServlet {
	...
	public void doGet(HttpServletRequest request,
	   ...
	   Address a = Connector.getAddress(request.getParameter("id"));
	   ...
	   out.println("City: <input type='text' name='city' value='" + a.getCity() + "'/><br/>");
	   out.println("Zip: <input type='text' name='zip' value='" + a.getZip() + "'/><br/>");
	   out.println("Street: <input type='text' name='street' value='" + a.getStreet() + "'/><br/>");
	   out.println("Apartment: <input type='text' name='apartment' value='" + a.getApartment() + "'/><br/>");
    ...
    throws ServletException, IOException {
		...
		String result = Connector.updateAddress(address);
		out.println(result);
	}
